    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['categories.store'], 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="card-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('seo_name', null, ['id' => 'seo_name', 'class' => 'form-control', 'placeholder' => 'SEO Name']) !!}
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('parent_id', ['' => 'Chọn chuyên mục cha'] + \App\Lib\Helpers::categoryList(), null, ['id' => 'parent_id',  'class' => 'form-control select2', 'data-placeholder' => 'Chọn chuyên mục cha...']) !!}
                            </div>
