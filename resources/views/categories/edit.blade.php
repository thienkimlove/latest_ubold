...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Chi tiết Chuyên mục</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['categories.update', $category->id], 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        @include('layouts.partials.errors')

                        <div class="form-group">
                            <label class="col-md-3 control-label">Tên chuyên mục</label>
                            <div class="col-md-9">
                                {!! Form::text('name', $category->name, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Name']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('desc', $category->desc, ['id' => 'desc', 'class' => 'form-control', 'placeholder' => 'Description']) !!}
                            </div>
                        </div>
                        ...
                        <div class="card-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('seo_name', $category->seo_name, ['id' => 'seo_name', 'class' => 'form-control', 'placeholder' => 'SEO Name']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::textarea('seo_desc', $category->seo_desc, ['id' => 'seo_desc', 'class' => 'form-control', 'placeholder' => 'SEO Description']) !!}
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Chuyên mục cha</label>
                            <div class="col-md-9">
                                {!! Form::select('parent_id', ['' => 'Chọn chuyên mục cha'] + \App\Lib\Helpers::categoryList(), $category->parent_id, ['id' => 'parent_id',  'class' => 'form-control select2', 'data-placeholder' => 'Chọn chuyên mục cha...']) !!}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::checkbox('status', '1', $category->status, ['data-plugin' => 'switchery', 'data-color' => '#81c868']) !!}
                                <span class="lbl"></span>
                            </div>
                        </div>
