    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a href="/videos/create"><button type="button" class="btn btn-default dropdown-toggle waves-effect" >Tạo mới <span class="m-l-5"><i class="fa fa-plus"></i></span></button></a>
            </div>
            <ol class="breadcrumb">
                <li class="active">
                    Danh sách Video
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Danh sách Video</b></h4>
...
@section('inline_scripts')
    <script type="text/javascript">
        ...
        $(function () {
            var datatable = $("#dataTables-videos").DataTable({
                searching: false,
                serverSide: true,
                processing: true,
                ajax: {
                    url: '{!! route('videos.dataTables') !!}',
                    data: function (d) {
            ...
            datatable.on('click', '[id^="btn-adjust-"]', function (e) {
                ...
                swal({
                    title: "Bạn có muốn duyệt Video này?",
                    text: "",
                    type: "warning",
