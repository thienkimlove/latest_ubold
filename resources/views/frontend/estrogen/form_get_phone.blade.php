...
<div class="box-intro">
    <div class="some-intro">
        <div class="pro-img">
            <img src="{{url('frontend/estrogen/images/bs-img.jpg')}}" alt="" width="206" height="199">
        </div>
        <div class="text">
            ...
            <b>Cách 2</b>: Gửi câu hỏi cho Thầy thuốc nhân dân, GS.TS Nguyễn Văn Mùi để được chuyên gia trả lời các thắc mắc của bạn <a href="{{url('lien-he')}}" target="_blank"><b>TẠI ĐÂY</b></a><br>
    ...
    <div class="form-get-phone">
            ...
            <input type="hidden" name="title" value="chi co dien thoai">
