...
<head>
    ...
    <link type="image/x-icon" href="{{url('frontend/hoaxuan/favicon.ico')}}" rel="shortcut icon"/>
    ...
    <link rel="stylesheet" href="{{url('frontend/hoaxuan/css/cagaileo.css')}}" type="text/css"/>
...
<div class="wrapper" id="wrapper">
    @include('frontend.hoaxuan.header')

    @yield('content')

    @include('frontend.hoaxuan.footer')
    <div class="overlay" id="overlay"></div>
    @include('frontend.hoaxuan.mobile_menu')
</div>
<div id="fb-root"></div>
<script>
...
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/jquery-1.10.2.min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/SmoothScroll.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/jquery.easing.min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/owl.carousel.min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/jquery.matchHeight-min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/common.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/fixedsidebar.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/hoaxuan/js/slideAdvs.js')}}"></script>
