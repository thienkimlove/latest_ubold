                    ...
                    <article class="detail delivery-detail">
                        ...
                        <ul class="listButton rs">
                            <li class="ilocal rs"><a href="{{url('phan-phoi')}}">
                                    <img src="{{ url('frontend/hoaxuan/images/diem-ban.png') }}" alt="Điểm bán sản phẩm" width="244" height="74">
                                </a></li>
                            <li class="icall rs"><a href="tel:0912571190">
                                    <img src="{{ url('frontend/hoaxuan/images/phan-phoi.png') }}" alt="Tư vấn miễn phí" width="244" height="74">
                                </a></li>
                        </ul>
                    </article>
