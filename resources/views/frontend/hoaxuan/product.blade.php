    ...
    <section class="section fix">
        <div class="layout-home">
            ...
            <div class="col-left">
                ...
                <!-- /paging -->
                <div class="boxPaging">
                    @include('frontend.hoaxuan.pagination', ['paginate' => $products])
                </div><!--//news-list-->
                <ul class="listAdv cf">
                    <li>
                        <a href="{{url('phan-phoi')}}">
                            <img src="{{url('frontend/hoaxuan/images/btn01.jpg')}}" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="{{url('lien-he')}}">
                            <img src="{{url('frontend/hoaxuan/images/btn02.jpg')}}" alt="">
                        </a>
                    </li>
                </ul>
