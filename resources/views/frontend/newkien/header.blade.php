<div class="hotLine sp">
    <img src="{{url('frontend/newkien/images/hot.png')}}" alt="">
  </div><header class="header">
    <div class="header-mid">
        <div class="fix">
            <h1>
                <a href="" title="" class="banner">
                    <img src="{{url('frontend/newkien/images/banner.png')}}" alt="">
                </a>
            </h1>
            ...
            <div class="phone">
                <img src="{{url('frontend/newkien/images/hotline.png')}}" alt="">
            </div>
        </div>
    </div>
    <nav class="bg-nav">
...
<div class="btn-group-fix banner-ads">
    <a href="javascript:void(0)" title="Fanpage"><img src="/frontend/newkien/images/fb-icon.png" alt="Fanpage" width="63" height="63"></a>
    <a href="tel:0912571190" title="Gọi tư vấn"><img src="/frontend/newkien/images/call-icon.png" alt="Gọi tư vấn" width="63" height="63"></a>
    <a href="{{url('phan-phoi')}}" title="Mua hàng"><img src="/frontend/newkien/images/cart-icon.png" alt="Giỏ hàng" width="63" height="63"></a>
    <a href="{{url('phan-phoi')}}" title="Điểm bán sản phẩm"><img src="/frontend/newkien/images/location-icon.png" alt="Điểm bán sản phẩm" width="63" height="63"></a>
</div>