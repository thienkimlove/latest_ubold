...
<head>
    ...
    <link type="image/x-icon" href="{{url('frontend/newkien/favicon.ico')}}" rel="shortcut icon"/>
...
<div class="wrapper" id="wrapper">
    @include('frontend.newkien.header')

    @yield('content')

    @include('frontend.newkien.footer')
    <div class="overlay" id="overlay"></div>
    @include('frontend.newkien.mobile_menu')
</div>
<div id="fb-root"></div>
<script>
...
<script type="text/javascript" src="{{url('frontend/newkien/js/jquery-1.10.2.min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/newkien/js/SmoothScroll.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/newkien/js/jquery.easing.min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/newkien/js/owl.carousel.min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/newkien/js/jquery.matchHeight-min.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/newkien/js/common.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/newkien/js/fixedsidebar.js')}}"></script>
<script type="text/javascript" src="{{url('frontend/newkien/js/slideAdvs.js')}}"></script>
