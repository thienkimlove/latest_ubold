    ...
    <section class="section fix">
        <div class="layout-home">
            ...
            <div class="col-left">
                ...
                <!-- /paging -->
                <div class="boxPaging">
                    @include('frontend.newkien.pagination', ['paginate' => $products])
                </div><!--//news-list-->
                <ul class="listAdv cf">
                    <li>
                        <a href="{{url('phan-phoi')}}">
                            <img src="{{url('frontend/newkien/images/btn01.jpg')}}" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="{{url('lien-he')}}">
                            <img src="{{url('frontend/newkien/images/btn02.jpg')}}" alt="">
                        </a>
                    </li>
                </ul>
