    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['comments.update', $comment->id], 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('status', ['' => 'Chọn Status'] + config('system.comment_content_status'), $comment->status, ['id' => 'status',  'class' => 'form-control select2', 'data-placeholder' => 'Chọn Status...']) !!}
                            </div>
