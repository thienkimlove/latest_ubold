    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a href="/positions/create"><button type="button" class="btn btn-default dropdown-toggle waves-effect" >Tạo mới <span class="m-l-5"><i class="fa fa-plus"></i></span></button></a>
            </div>
            <ol class="breadcrumb">
                <li class="active">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Danh sách Vị trí Banner</b></h4>
                <p class="text-muted font-13 m-b-30"></p>
                <table id="dataTables-positions" class="table table-striped table-bordered table-actions-bar">
                    <thead>
                    <tr>
                        <th width="40%">Tên Vị trí Banner</th>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            var dataTable = $("#dataTables-positions").DataTable({
                ...
                processing: true,
                ajax: {
                    url: '{!! route('positions.dataTables') !!}',
                    data: function (d) {
