...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Tạo mới Thiết lập</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['settings.store'], 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('value', null, ['id' => 'value', 'class' => 'form-control', 'placeholder' => 'Description']) !!}
                            </div>
                        </div>
