    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['stores.store'], 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('district_id', ['' => 'Chọn Quận/Huyện'] + \App\Lib\Helpers::districtList(), null, ['id' => 'district_id',  'class' => 'form-control select2', 'data-placeholder' => 'Chọn Quận/Huyện...']) !!}
                            </div>
