...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Chi tiết Địa điểm phân phối</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['stores.update', $store->id], 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        @include('layouts.partials.errors')

                        <div class="form-group">
                            <label class="col-md-3 control-label">Tên</label>
                            <div class="col-md-9">
                                {!! Form::text('name', $store->name, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Name']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('phone', $store->phone, ['id' => 'phone', 'class' => 'form-control', 'placeholder' => 'Phone']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('address', $store->address, ['id' => 'address', 'class' => 'form-control', 'placeholder' => 'Address']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('district_id', ['' => 'Chọn Quận/Huyện'] + \App\Lib\Helpers::districtList(), $store->district_id, ['id' => 'district_id',  'class' => 'form-control select2', 'data-placeholder' => 'Chọn Quận/Huyện...']) !!}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static">{{ $store->created_at }}</p>
                            </div>
                        </div>
