    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['tags.update', $tag->id], 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="card-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('seo_name', $tag->seo_name, ['id' => 'seo_name', 'class' => 'form-control', 'placeholder' => 'SEO Name']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::textarea('seo_desc', $tag->seo_desc, ['id' => 'seo_desc', 'class' => 'form-control', 'placeholder' => 'SEO Description']) !!}
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static">{{ $tag->created_at }}</p>
                            </div>
                        </div>
