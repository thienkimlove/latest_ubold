    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['users.update', $user->id], 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('roles[]', \App\Lib\Helpers::roleList(), $user->roles()->pluck('id')->all(), ['id' => 'roles', 'multiple' => true, 'class' => 'form-control select2 select2-multiple', 'data-placeholder' => 'Choose Roles...', 'style' => 'width:100%']) !!}
                            </div>
